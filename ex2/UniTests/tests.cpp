...
TEST_CASE("CardCtor")
{
    ...
    SECTION("BattleCard")
    {
        Card a = Card(CardType::Battle, CardStats(loot = 5, force = 12, hpLoss = 10));
        Card b = Card(CardType::Battle, CardStats(loot = 5, force = -10, hpLoss = 10));
        Card c = Card(CardType::Battle, CardStats(loot = 5, force = 12, hpLoss = -30));
        Card d = Card(CardType::Battle, CardStats(loot = -60, force = 12, hpLoss = -30));
        Card e = Card(CardType::Battle, CardStats(0, 0));
        // Check card params
    }

    SECTION("TreasureCard")
    {
        Card a = Card(CardType::Treasure, CardStats(loot = 5, force = 12, hpLoss = 10));
        Card b = Card(CardType::Treasure, CardStats(loot = 5));
        Card c = Card(CardType::Treasure, CardStats(loot = 10));
        Card d = Card(CardType::Treasure, CardStats(9090));
    }

    SECTION("HealCard")
    {
        Card a = Card(CardType::Heal, CardStats(cost = 5, heal = 10));
        Card b = Card(CardType::Heal, CardStats(cost = -5, heal = 1));
        Card c = Card(CardType::Heal, CardStats(cost = 15, heal = -5));
    }

    SECTION("BuffCard")
    {
        Card a = Card(CardType::Buff, CardStats(cost = 5, buff = 10));
        Card b = Card(CardType::Buff, CardStats(cost = -5, buff = 1));
        Card c = Card(CardType::Buff, CardStats(cost = 15, buff = -5));
    }
}*/
